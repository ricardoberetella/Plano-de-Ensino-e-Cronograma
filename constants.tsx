...
export const FUSI_SCHEDULE = [
  ...
  { id: 'f03', hours: 4, date: '29/01/2026', capacities: 'Definir parameters; Torneamento; Parâmetros de corte/ferramenta.', knowledge: 'Torneamento Convencional', strategy: 'Exposição dialogada: Apresentação da SA2 e cálculos técnicos.', resources: 'Sala de aula, projetor.' },
  ...
  { id: 'f55', hours: 4, date: '10/06/2026', capacities: 'Elaborar plano de trabalho de acordo com normas e procedimentos de meio ambiente, de saúde e segurança no trabalho.', knowledge: 'Desenvolvimento Profissional', strategy: 'Atitudes, responsabilidade e zelo com patrimônio.', resources: 'Sala de aula.' },
...
// --- CRONOGRAMA FUSI_GEA (TURMA TERÇA/QUARTA/SEXTA) ---
...
// --- EXPORTAÇÃO DOS PLANOS EXIGIDA PELO APP.TSX ---
// Esta constante resolve o erro de importação do Vite/Rollup de forma definitiva!
export const SAMPLE_PLANS: TeachingPlan[] = [
  ...
  {
    id: "crd-plan",
    name: "Controle Re dimensional (CRD)",
    version: SCHEDULE_VERSION,
    curricularUnits: [
      {
        id: "crd-unit",
  ...
  {
    id: "fusi-plan",
    name: "Fabricação por Usinagem Convencional (FUSI)",
    version: SCHEDULE_VERSION,
    curricularUnits: [
      {
        id: "fusi-unit",
      ...
      },
      {
        id: "fusi-gea-unit",
        name: "FUSI GEA",
        hours: 44, // Totalizando a parte atualizada do FUSI GEA

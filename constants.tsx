...
export const SCHEDULE_VERSION = "2026-V14-BERETELLA-60-PDF-FINAL";
...
// --- CRONOGRAMA FUSI (BERETELLA - 60 AULAS / 240H - FIEL AO PDF FINAL) ---
export const FUSI_SCHEDULE = [
  { id: 'f01', hours: 4, date: '26/01/26', knowledge: 'Parâmetros de corte (Vc, n, f, ap); Geometria de ferramentas; Demonstrar atenção a detalhes.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Cálculos de RPM para o Eixo 4 Corpos.', resources: 'Sala de aula, projetor.' },
  { id: 'f02', hours: 4, date: '28/01/26', knowledge: 'Tecnologia de Facear e Furar centro; Segurança (NR-12); Demonstrar senso crítico.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Procedimentos técnicos da Tarefa 0001.', resources: 'Oficina, Torno.' },
  { id: 'f03', hours: 4, date: '29/01/26', knowledge: 'Tornear superfície cilíndrica externa e Chanfrar; Demonstrar pensamento analítico.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Planeamento de desbaste e acabamento.', resources: 'Oficina, Torno.' },
  { id: 'f04', hours: 4, date: '02/02/26', knowledge: 'Elaboração de Folha de Processo; Zelo pelo património; Meio Ambiente.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Redação do roteiro de trabalho (Tarefa 0001).', resources: 'Sala de aula.' },
  { id: 'f05', hours: 4, date: '04/02/26', knowledge: 'Tecnologia da Fresagem: Fresar superfícies planas; Demonstrar escuta ativa.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Estudo de ferramentas para o Bloco Fresado.', resources: 'Oficina, Fresadora.' },
  { id: 'f06', hours: 4, date: '05/02/26', knowledge: 'Fresar superfícies paralelas e perpendiculares (Esquadrejamento).', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Análise dimensional da Tarefa 0007.', resources: 'Oficina, Fresadora.' },
  { id: 'f07', hours: 4, date: '09/02/26', knowledge: 'Metrologia: Paquímetro e Micrômetro; Rigor técnico e precisão.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Simulação de medição e relatórios.', resources: 'Sala de aula.' },
  { id: 'f08', hours: 4, date: '11/02/26', knowledge: 'Tecnologia de Cortar no torno (Bedame); Visão sistémica da peça.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Planeamento de canais e sangramento.', resources: 'Oficina, Torno.' },
  { id: 'f09', hours: 4, date: '12/02/26', knowledge: 'Fluidos de corte; Refrigeração; Consciência ambiental (Resíduos).', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Estudo sobre rugosidade e lubrificação.', resources: 'Oficina.' },
  { id: 'f10', hours: 4, date: '18/02/26', knowledge: 'Tecnologia de Fresar rebaixos; Demonstrar proatividade.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Cálculo de zeramento (Tarefa 0007).', resources: 'Oficina, Fresadora.' },
  { id: 'f11', hours: 4, date: '19/02/26', knowledge: 'Processos de furação; Velocidades; Trabalho em equipa.', capacities: 'Capacidades Básicas e Socioemocionais', strategy: 'Revisão final para entrada na oficina.', resources: 'Oficina.' },
  { id: 'f12', hours: 4, date: '23/02/26', knowledge: 'Tecnologia de Roscas; Cálculos de passo; Demonstrar escuta ativa.', capacities: 'Operações do Quadro Analítico', strategy: 'Teoria para Eixo Roscado e Manípulo.', resources: 'Sala de aula.' },
  { id: 'f13', hours: 4, date: '25/02/26', knowledge: 'Facear, Centrar, Cilindrar e Roscar com cossinete.', capacities: 'Capacidades Técnicas', strategy: 'Tarefa 0006 (Eixo Roscado).', resources: 'Oficina, Torno.' },
  { id: 'f14', hours: 4, date: '26/02/26', knowledge: 'Furar em furadeira e Roscar manual com macho.', capacities: 'Capacidades Técnicas', strategy: 'Tarefa 0009 (Manípulo).', resources: 'Oficina, Bancada.' },
  { id: 'f15', hours: 4, date: '02/03/26', knowledge: 'Elementos de fixação; Visão sistémica; Planeamento do Desafio 1.', capacities: 'Capacidades Técnicas', strategy: 'Início: Calculador de Usinagem.', resources: 'Sala de aula.' },
  { id: 'f16', hours: 4, date: '04/03/26', knowledge: 'Torno: Facear; Cilindrar externo; Chanfrar; Atenção a detalhes.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Base do Calculador.', resources: 'Oficina, Torno.' },
  { id: 'f17', hours: 4, date: '05/03/26', knowledge: 'Fresa: Facear superfícies; Esquadrejar bloco.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Bloco Principal.', resources: 'Oficina, Fresadora.' },
  { id: 'f18', hours: 4, date: '09/03/26', knowledge: 'Ajustagem mecânica; Tolerâncias; Ética profissional.', capacities: 'Capacidades Técnicas', strategy: 'Estudo de encaixes do projeto.', resources: 'Sala de aula.' },
  { id: 'f19', hours: 4, date: '11/03/26', knowledge: 'Torno: Cilindrar rebaixos; Furo de centro; Sangrar.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Pinos e eixos.', resources: 'Oficina, Torno.' },
  { id: 'f20', hours: 4, date: '12/03/26', knowledge: 'Fresa: Fresar rebaixos; Controle de profundidade.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Alojamentos.', resources: 'Oficina, Fresadora.' },
  { id: 'f21', hours: 4, date: '16/03/26', knowledge: 'Furação Coordenada; Localização em fresadora; Pensamento crítico.', capacities: 'Capacidades Técnicas', strategy: 'Teoria para furação de precisão.', resources: 'Sala de aula.' },
  { id: 'f22', hours: 4, date: '18/03/26', knowledge: 'Furar e Roscar manual; Ajuste de profundidade.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Fixação do bloco.', resources: 'Oficina, Bancada.' },
  { id: 'f23', hours: 4, date: '19/03/26', knowledge: 'Furar em fresadora; Inspeção rigorosa; Autogestão.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Furação coordenada.', resources: 'Oficina, Fresadora.' },
  { id: 'f24', hours: 4, date: '23/03/26', knowledge: 'Segurança NR-12; Manutenção preventiva; Responsabilidade.', capacities: 'Capacidades Técnicas', strategy: 'Teoria de conservação de máquinas.', resources: 'Sala de aula.' },
  { id: 'f25', hours: 4, date: '25/03/26', knowledge: 'Torno: Acabamento superficial; Polimento; Medição final.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Finalização dos pinos.', resources: 'Oficina, Torno.' },
  { id: 'f26', hours: 4, date: '26/03/26', knowledge: 'Fresa: Acabamento de faces; Inspeção final com Micrômetro.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Finalização do bloco.', resources: 'Oficina, Fresadora.' },
  { id: 'f27', hours: 4, date: '30/03/26', knowledge: 'Documentação técnica; Relatórios de controlo de qualidade.', capacities: 'Capacidades Técnicas', strategy: 'Finalização documental.', resources: 'Sala de aula.' },
  { id: 'f28', hours: 4, date: '01/04/26', knowledge: 'Ajustagem manual (Lima); Rebarbação técnica.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Ajustagem de bancada.', resources: 'Oficina, Bancada.' },
  { id: 'f29', hours: 4, date: '02/04/26', knowledge: 'Montagem de conjuntos; Testes funcionais; Trabalho em equipa.', capacities: 'Capacidades Técnicas', strategy: 'Desafio 1: Montagem final.', resources: 'Oficina, Bancada.' },
  { id: 'f30', hours: 4, date: '06/04/26', knowledge: 'Revisão técnica de processos básicos de usinagem.', capacities: 'Capacidades Técnicas', strategy: 'Consolidação de conceitos.', resources: 'Sala de aula.' },
  { id: 'f31', hours: 4, date: '08/04/26', knowledge: 'Torno: Reforço de Cilindrar e Chanfrar.', capacities: 'Capacidades Técnicas', strategy: 'Peça de reforço operacional.', resources: 'Oficina, Torno.' },
  { id: 'f32', hours: 4, date: '09/04/26', knowledge: 'Fresa: Reforço de Fresar superfícies planas.', capacities: 'Capacidades Técnicas', strategy: 'Peça de reforço operacional.', resources: 'Oficina, Fresadora.' },
  { id: 'f33', hours: 4, date: '13/04/26', knowledge: 'Higiene e Segurança; Atitude prevencionista na oficina.', capacities: 'Operações do Quadro Analítico', strategy: 'Revisão de comportamento seguro.', resources: 'Sala de aula.' },
  { id: 'f34', hours: 4, date: '15/04/26', knowledge: 'Prática Supervisionada: Repetição de operações do Quadro.', capacities: 'Capacidades Técnicas', strategy: 'Foco em autonomia operacional.', resources: 'Oficina.' },
  { id: 'f35', hours: 4, date: '16/04/26', knowledge: 'Prática Supervisionada: Esquadrejamento na fresa.', capacities: 'Capacidades Técnicas', strategy: 'Foco em precisão dimensional.', resources: 'Oficina.' },
  { id: 'f36', hours: 4, date: '22/04/26', knowledge: 'Montagem e Ajuste: Verificação de folgas.', capacities: 'Capacidades Técnicas', strategy: 'Prática de montagem técnica.', resources: 'Oficina.' },
  { id: 'f37', hours: 4, date: '23/04/26', knowledge: 'Controlo dimensional com Relógio Comparador.', capacities: 'Capacidades Técnicas', strategy: 'Medição de batimento no torno.', resources: 'Oficina.' },
  { id: 'f38', hours: 4, date: '25/04/26', knowledge: 'Ajustagem: Recuperação de faces e acabamento manual.', capacities: 'Capacidades Técnicas', strategy: 'Melhoria de peças do portfólio.', resources: 'Oficina.' },
  { id: 'f39', hours: 4, date: '27/04/26', knowledge: 'Organização Industrial: Produtividade e fluxo de trabalho.', capacities: 'Operações do Quadro Analítico', strategy: 'Estudo de tempos e movimentos.', resources: 'Sala de aula.' },
  { id: 'f40', hours: 4, date: '29/04/26', knowledge: 'Torno: Facear; Cilindrar; Furar; Demonstrar atenção.', capacities: 'Capacidades Técnicas', strategy: 'Início da Tarefa 0010.', resources: 'Oficina.' },
  { id: 'f41', hours: 4, date: '30/04/26', knowledge: 'Fresa: Fresar rebaixos; Esquadrejar.', capacities: 'Capacidades Técnicas', strategy: 'Continuidade da Tarefa 0010.', resources: 'Oficina.' },
  { id: 'f42', hours: 4, date: '04/05/26', knowledge: 'Usinabilidade de materiais (Aço, Alumínio, Bronze).', capacities: 'Operações do Quadro Analítico', strategy: 'Parâmetros aplicados.', resources: 'Sala de aula.' },
  { id: 'f43', hours: 4, date: '06/05/26', knowledge: 'Roscar com cossinete; Verificação dimensional.', capacities: 'Capacidades Técnicas', strategy: 'Prática de rosqueamento.', resources: 'Oficina.' },
  { id: 'f44', hours: 4, date: '07/05/26', knowledge: 'Esquadrejamento de precisão (Blocos paralelos).', capacities: 'Capacidades Técnicas', strategy: 'Foco em paralelismo.', resources: 'Oficina.' },
  { id: 'f45', hours: 4, date: '11/05/26', knowledge: 'Gestão da Qualidade: Tratamento de erros e Resiliência.', capacities: 'Operações do Quadro Analítico', strategy: 'Teoria de resolução de problemas.', resources: 'Sala de aula.' },
  { id: 'f46', hours: 4, date: '13/05/26', knowledge: 'Sangrar (Corte com bedame); Canais internos.', capacities: 'Capacidades Técnicas', strategy: 'Prática de sangramento seguro.', resources: 'Oficina.' },
  { id: 'f47', hours: 4, date: '14/05/26', knowledge: 'Roscar manual em furos cegos.', capacities: 'Capacidades Técnicas', strategy: 'Técnica de roscagem interna.', resources: 'Oficina.' },
  { id: 'f48', hours: 4, date: '18/05/26', knowledge: 'Elementos de Máquina: Chavetas, Polias e Eixos.', capacities: 'Operações do Quadro Analítico', strategy: 'Teoria mecânica.', resources: 'Sala de aula.' },
  { id: 'f49', hours: 4, date: '21/05/26', knowledge: 'Ajustes e Verificação dimensional de conjuntos.', capacities: 'Capacidades Técnicas', strategy: 'Teste funcional de peças.', resources: 'Oficina.' },
  { id: 'f50', hours: 4, date: '25/05/26', knowledge: 'Gestão de Ferramental: Desgaste e vida útil.', capacities: 'Operações do Quadro Analítico', strategy: 'Organização técnica.', resources: 'Sala de aula.' },
  { id: 'f51', hours: 4, date: '27/05/26', knowledge: 'Torneamento: Acabamento fino e polimento.', capacities: 'Capacidades Técnicas', strategy: 'Qualidade superficial.', resources: 'Oficina.' },
  { id: 'f52', hours: 4, date: '28/05/26', knowledge: 'Fresagem: Faceamento final com cabeçote.', capacities: 'Capacidades Técnicas', strategy: 'Planeza e brilho.', resources: 'Oficina.' },
  { id: 'f53', hours: 4, date: '01/06/26', knowledge: 'Revisão de Fundamentos: Torneamento e Fresagem.', capacities: 'Operações do Quadro Analítico', strategy: 'Consolidação final.', resources: 'Sala de aula.' },
  { id: 'f54', hours: 4, date: '03/06/26', knowledge: 'Oficina de Finalização: Ajustes e rebarbação.', capacities: 'Capacidades Técnicas', strategy: 'Conclusão de pendências.', resources: 'Oficina.' },
  { id: 'f55', hours: 4, date: '08/06/26', knowledge: 'Ética e Relações Interpessoais na Indústria.', capacities: 'Operações do Quadro Analítico', strategy: 'Postura profissional.', resources: 'Sala de aula.' },
  { id: 'f56', hours: 4, date: '10/06/26', knowledge: 'Manutenção Preventiva: Limpeza e lubrificação.', capacities: 'Capacidades Técnicas', strategy: 'Cuidado com o equipamento.', resources: 'Oficina.' },
  { id: 'f57', hours: 4, date: '11/06/26', knowledge: 'Controlo de Qualidade Final de todas as peças.', capacities: 'Capacidades Técnicas', strategy: 'Inspeção do portfólio.', resources: 'Oficina.' },
  { id: 'f58', hours: 4, date: '17/06/26', knowledge: 'Organização de ferramentas e bancadas individuais.', capacities: 'Capacidades Técnicas', strategy: 'Preparação para encerramento.', resources: 'Oficina.' },
  { id: 'f59', hours: 4, date: '18/06/26', knowledge: 'Organização da Oficina: Inventário e limpeza profunda.', capacities: 'Capacidades Técnicas', strategy: 'Organização Geral - Dia 1.', resources: 'Oficina.' },
  { id: 'f60', hours: 4, date: '22/06/26', knowledge: 'Organização da Oficina: Entrega do ambiente e ferramentas.', capacities: 'Capacidades Técnicas', strategy: 'Encerramento - Dia 2.', resources: 'Oficina.' }
];

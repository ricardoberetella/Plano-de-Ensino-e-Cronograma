...
// --- CRONOGRAMA FUSI (PADRÃO BERETELLA - 60 AULAS) ---
export const FUSI_SCHEDULE = [
  ...
  { id: 'f38', hours: 4, date: '27/04/2026', capacities: 'Controle da qualidade das peças; Inspeção dimensional.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Avaliação dimensional total (Micrômetro).', resources: 'Sala de aula, Micrômetro.' },
  ...
  { id: 'f48', hours: 4, date: '20/05/2026', capacities: 'Ajustagem mecânica: Limagem plana.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Prática de ajustagem ao banco (precisão manual).', resources: 'Bancada, Limas.' },
  ...
  { id: 'f50', hours: 4, date: '25/05/2026', capacities: 'Controle dimensional de conjuntos montados.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Testes funcionais e ajustes de interferência.', resources: 'Oficina de usinagem.' },
  ...
  { id: 'f52', hours: 4, date: '28/05/2026', capacities: 'Preparação para Avaliação Final (Teoria).', knowledge: 'TEORIA (TEOR)', strategy: 'Revisão integral dos conteúdos dos Prints 1, 2 e 3.', resources: 'Sala de aula.' },

...
export const SCHEDULE_VERSION = "2026-V12-BERETELLA-PDF";
...
export const FUSI_SCHEDULE_GEA = [
  ...
  { id: 'g29', hours: 4, date: '31/03/2026', capacities: 'Inspeção visual; Verificação funcional de conjuntos.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Desafio 1: Pró-montagem e detecção de interferências.', resources: 'Bancada.' },
...
// --- CRONOGRAMA FUSI (PADRÃO BERETELLA - FIEL AO PDF DO USUÁRIO) ---
export const FUSI_SCHEDULE = [
  { id: 'f01', hours: 4, date: '26/01/2026', knowledge: 'TEORIA (TEOR) Introdução e Parâmetros', capacities: 'Definir parâmetros de corte (Vc, n, f, ap). Geometria de ferramentas para Torneamento e Fresagem.', strategy: 'Exposição dialogada e exercícios de cálculo de RPM e Avanço.', resources: 'Sala de aula, projetor.' },
  { id: 'f02', hours: 4, date: '28/01/2026', knowledge: 'TEORIA (TEOR) Operações de Torno I', capacities: 'Tecnologia de Facear no torno e Furar centro. Tipos de acessórios e fixação de peças.', strategy: 'Aula expositiva com foco na segurança e procedimentos da Tarefa 0001.', resources: 'Sala de aula, Torno.' },
  { id: 'f03', hours: 4, date: '29/01/2026', knowledge: 'TEORIA (TEOR) Operações de Torno II', capacities: 'Tecnologia de Tornear superfície cilíndrica externa (passagem e rebaixo) e Chanfrar.', strategy: 'Planejamento da sequência de desbaste e acabamento.', resources: 'Sala de aula.' },
  { id: 'f04', hours: 4, date: '02/02/2026', knowledge: 'TEORIA (TEOR) Planejamento', capacities: 'Elaborar folha de processo; Segurança NR-12; Higiene e Meio Ambiente (Descarte de cavacos).', strategy: 'Oficina de elaboração de roteiro de trabalho para as primeiras peças.', resources: 'Sala de aula, Normas NR-12.' },
  { id: 'f05', hours: 4, date: '04/02/2026', knowledge: 'TEORIA (TEOR) Operações de Fresa I', capacities: 'Tecnologia de Fresar superfícies planas com cabeçote e fresa de topo. Parâmetros de corte.', strategy: 'Estudo dirigido: Seleção de ferramentas para o Bloco Fresado.', resources: 'Sala de aula, Fresadora.' },
  { id: 'f06', hours: 4, date: '05/02/2026', knowledge: 'TEORIA (TEOR) Operações de Fresa II', capacities: 'Tecnologia de Fresar superfícies paralelas e perpendiculares (Esquadrejamento).', strategy: 'Análise técnica do esquadrejamento e controle de perpendicularismo.', resources: 'Sala de aula.' },
  { id: 'f07', hours: 4, date: '09/02/2026', knowledge: 'TEORIA (TEOR) Metrologia Industrial', capacities: 'Inspeção dimensional; Tolerâncias ISO; Uso de Paquímetro e Micrômetro na máquina.', strategy: 'Teoria aplicada ao controle de qualidade das peças do 1º semestre.', resources: 'Sala de aula, Instrumentos.' },
  { id: 'f08', hours: 4, date: '11/02/2026', knowledge: 'TEORIA (TEOR) Corte e Canais', capacities: 'Tecnologia de Cortar no torno (Bedame) e Abrir canais externos/rebaixos.', strategy: 'Planejamento de operações de sangramento e uso de bedames.', resources: 'Sala de aula, Torno.' },
  { id: 'f09', hours: 4, date: '12/02/2026', knowledge: 'TEORIA (TEOR) Fluidos e Manutenção', capacities: 'Refrigeração e lubrificação; Manutenção autônoma das máquinas convencionais.', strategy: 'Estudo sobre o impacto dos fluidos na rugosidade e vida da ferramenta.', resources: 'Sala de aula.' },
  { id: 'f10', hours: 4, date: '18/02/2026', knowledge: 'TEORIA (TEOR) Usinagem de Canais e Rebaixos', capacities: 'Tecnologia de Fresar rebaixos e canais na fresadora. Localização e zeramento.', strategy: 'Cálculo de posicionamento para rasgos de chaveta e alojamentos.', resources: 'Sala de aula, Fresadora.' },
  { id: 'f11', hours: 4, date: '19/02/2026', knowledge: 'TEORIA (TEOR) Furação Técnica', capacities: 'Processos de furação; Brocas helicoidais; Afiação de brocas; Velocidades de avanço.', strategy: 'Revisão final dos planos de trabalho para entrada na oficina.', resources: 'Sala de aula.' },
  { id: 'f12', hours: 4, date: '23/02/2026', knowledge: 'TEORIA (TEOR) Tecnologia de Roscas', capacities: 'Roscas triangulares (Métricas e Polegada); Cálculos de passo e diâmetro de broca.', strategy: 'Início da fase de rosqueamento. Teoria pré-prática.', resources: 'Sala de aula.' },
  { id: 'f13', hours: 4, date: '25/02/2026', knowledge: 'PRÁTICA (PRAT) Operações de Torno', capacities: 'Facear; Furo de centro; Tornear cilíndrica; Roscar com cossinete.', strategy: 'Tarefa (Eixo Roscado): Execução prática conforme Quadro Analítico.', resources: 'Oficina, Torno, Cossinete.' },
  { id: 'f14', hours: 4, date: '26/02/2026', knowledge: 'PRÁTICA (PRAT) Furação e Rosca Manual', capacities: 'Furação em furadeira; Roscar manualmente com macho na bancada.', strategy: 'Tarefa (Manípulo): Execução prática de furação e rosca.', resources: 'Oficina, Bancada, Machos.' },
  { id: 'f15', hours: 4, date: '02/03/2026', knowledge: 'TEORIA (TEOR) Elementos de Máquina', capacities: 'Elementos de fixação e transmissão. Visão sistêmica aplicada ao Desafio 1.', strategy: 'Planejamento técnico para o início do projeto final do semestre.', resources: 'Sala de aula.' },
  { id: 'f16', hours: 4, date: '04/03/2026', knowledge: 'PRÁTICA (PRAT) Operações de Torno', capacities: 'Facear; Tornear cilíndrica; Chanfrar; Controle dimensional rigoroso.', strategy: 'Desafio 1: Início da usinagem da base do Calculador de Usinagem.', resources: 'Oficina, Torno.' },
  { id: 'f17', hours: 4, date: '05/03/2026', knowledge: 'PRÁTICA (PRAT) Operações de Fresa', capacities: 'Fresar superfícies planas; Esquadrejar bloco; Controle de planeza.', strategy: 'Desafio 1: Início da usinagem do Bloco do Calculador.', resources: 'Oficina, Fresadora.' },
  { id: 'f18', hours: 4, date: '09/03/2026', knowledge: 'TEORIA (TEOR) Ajustagem Mecânica', capacities: 'Teoria de ajustes e tolerâncias; Folgas e interferências em montagens.', strategy: 'Estudo dos ajustes necessários para a montagem do Desafio 1.', resources: 'Sala de aula.' },
  { id: 'f19', hours: 4, date: '11/03/2026', knowledge: 'PRÁTICA (PRAT) Torno (Avançado)', capacities: 'Tornear cilíndrica com rebaixos; Sangrar (Abrir canais); Chanfrar.', strategy: 'Desafio 1: Usinagem dos pinos e componentes de rotação.', resources: 'Oficina, Torno.' },
  { id: 'f20', hours: 4, date: '12/03/2026', knowledge: 'PRÁTICA (PRAT) Fresa (Avançado)', capacities: 'Fresar rebaixos e canais; Controle de profundidade com relógio comparador.', strategy: 'Desafio 1: Alojamentos e guias do corpo principal.', resources: 'Oficina, Fresadora.' },
  { id: 'f21', hours: 4, date: '16/03/2026', knowledge: 'TEORIA (TEOR) Furação Coordenada', capacities: 'Tecnologia de furação coordenada em fresadora universal; Réguas digitais.', strategy: 'Teoria para furações de precisão no bloco do calculador.', resources: 'Sala de aula.' },
  { id: 'f22', hours: 4, date: '18/03/2026', knowledge: 'PRÁTICA (PRAT) Usinagem de Roscas', capacities: 'Furação de precisão; Rosqueamento manual e ajuste de profundidade.', strategy: 'Desafio 1: Furações de montagem e fixação.', resources: 'Oficina, Bancada.' },
  { id: 'f23', hours: 4, date: '19/03/2026', knowledge: 'PRÁTICA (PRAT) Fresa/Controle', capacities: 'Furação em fresadora; Inspeção de qualidade dimensional e geométrica.', strategy: 'Desafio 1: Furação coordenada e verificação de gabarito.', resources: 'Oficina, Fresadora.' },
  { id: 'f24', hours: 4, date: '23/03/2026', knowledge: 'TEORIA (TEOR) Gestão e Segurança', capacities: 'NR-12; Manutenção preventiva; Organização (5S); Descarte de resíduos.', strategy: 'Teoria sobre boas práticas e conservação do ferramental.', resources: 'Sala de aula.' },
  { id: 'f25', hours: 4, date: '25/03/2026', knowledge: 'PRÁTICA (PRAT) Torno (Finalização)', capacities: 'Acabamento superficial (Polimento); Recartilhar (se aplicável); Medição final.', strategy: 'Desafio 1: Finalização estética e dimensional dos eixos.', resources: 'Oficina, Torno.' },
  { id: 'f26', hours: 4, date: '26/03/2026', knowledge: 'PRÁTICA (PRAT) Fresa (Finalização)', capacities: 'Acabamento de faces; Inspeção dimensional total com micrômetro.', strategy: 'Desafio 1: Acabamento final das superfícies do bloco.', resources: 'Oficina, Fresadora.' },
  { id: 'f27', hours: 4, date: '30/03/2026', knowledge: 'TEORIA (TEOR) Qualidade', capacities: 'Elaboração de relatórios de inspeção; Controle de processos de fabricação.', strategy: 'Documentação final do Desafio 1.', resources: 'Sala de aula.' },
  { id: 'f28', hours: 4, date: '01/04/2026', knowledge: 'PRÁTICA (PRAT) Ajustagem de Bancada', capacities: 'Limagem técnica; Rebarbação; Ajuste fino de encaixes.', strategy: 'Desafio 1: Ajustagem manual para a montagem final.', resources: 'Oficina, Bancada.' },
  { id: 'f29', hours: 4, date: '02/04/2026', knowledge: 'PRÁTICA (PRAT) Montagem e Teste', capacities: 'Montagem de conjuntos; Verificação funcional do calculador.', strategy: 'Desafio 1: Entrega do projeto montado e testado.', resources: 'Oficina, Bancada.' }
];

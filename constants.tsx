...
export const SCHEDULE_VERSION = "2026-V12-GEA-AJUSTAGEM-FIX";
...
export const LIDT_SCHEDULE = [
  ...
  { id: 'l16', date: '25/05/2026', hours: 2, capacities: 'Todas as capacities da SA.', knowledge: 'Todos os conhecimentos da SA.', strategy: '• Continuação e refinamento dos croquis.', resources: 'Dossiê em phase de conclusão.' },
...
export const FUSI_SCHEDULE_GEA = [
  ...
  { id: 'g18', hours: 4, date: '04/03/2026', capacities: 'Revisão de tolerâncias; Realizar operações de ajustagem.', knowledge: 'TEORIA (TEOR)', strategy: 'Estudo de ajustes e folgas para montagem do Desafio 1.', resources: 'Sala de aula.' },
  ...
  { id: 'g28', hours: 4, date: '30/03/2026', capacities: 'Realizar operações de ajustagem; Rebarbação; Limagem técnica.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Desafio 1: Ajustagem manual das peças para encaixe.', resources: 'Bancada, Limas.' },
  ...
  { id: 'g32', hours: 4, date: '07/04/2026', capacities: 'Fresar; Furação de precisão; Controle de qualidade.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Tarefa Reforço: Ajuste de blocos paralelos.', resources: 'Oficina de usinagem, Fresadora.' },
  ...
  { id: 'g38', hours: 4, date: '27/04/2026', capacities: 'Controlar a qualidade das peças; Inspeção dimensional.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Avaliação dimensional total (Micrômetro).', resources: 'Sala de aula, Micrômetro.' },
  ...
  { id: 'g48', hours: 4, date: '19/05/2026', capacities: 'Realizar operações de ajustagem; Limagem plana.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Prática de ajustagem ao banco (precisão manual).', resources: 'Bancada, Limas.' },
  ...
  { id: 'g50', hours: 4, date: '25/05/2026', capacities: 'Controlar a qualidade das peças; Controle dimensional.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Testes funcionais e ajustes de interferência.', resources: 'Oficina de usinagem.' },
...
export const FUSI_SCHEDULE = [
  ...
  { id: 'f07', hours: 4, date: '09/02/2026', capacities: 'Controlar a qualidade das peças; Inspeção dimensional; Instrumentos.', knowledge: 'TEORIA (TEOR)', strategy: 'Teoria sobre Metrologia aplicada e tolerâncias ISO.', resources: 'Sala de aula, Projetor.' },
  ...
  { id: 'f09', hours: 4, date: '12/02/2026', capacities: 'Inspeção dimensional; Aplicar os procedimentos de refrigeração; Zelar pelo equipamento.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Tarefa: Eixo 4 Corpos. Controle final e organização.', resources: 'Oficina de usinagem, Micrômetro.' },
  ...
  { id: 'f11', hours: 4, date: '19/02/2026', capacities: 'Aplicar os procedimentos de refrigeração; Fresagem (Operações avançadas).', knowledge: 'PRÁTICA (PRAT)', strategy: 'Tarefa: Bloco Fresado. Prática de acabamento em fresa.', resources: 'Oficina de usinagem, Fresadora.' },
  ...
  { id: 'f18', hours: 4, date: '09/03/2026', capacities: 'Revisão de tolerâncias; Realizar operações de ajustagem.', knowledge: 'TEORIA (TEOR)', strategy: 'Estudo de ajustes e folgas para montagem do Desafio 1.', resources: 'Sala de aula.' },
  ...
  { id: 'f23', hours: 4, date: '19/03/2026', capacities: 'Furação em fresadora; Controlar a qualidade.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Desafio 1: Furação coordenada do corpo do calculador.', resources: 'Oficina de usinagem, Fresadora.' },
  ...
  { id: 'f28', hours: 4, date: '01/04/2026', capacities: 'Realizar operações de ajustagem; Rebarbação; Limagem técnica.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Desafio 1: Ajustagem manual das peças para encaixe.', resources: 'Bancada, Limas.' },
  { id: 'f29', hours: 4, date: '02/04/2026', capacities: 'Inspeção visual; Verificação functional de conjuntos.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Desafio 1: Pré-montagem e detecção de interferências.', resources: 'Bancada.' },
  ...
  { id: 'f32', hours: 4, date: '09/04/2026', capacities: 'Fresar; Furação de precisão; Controlar a qualidade das peças.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Tarefa Reforço: Ajuste de blocos paralelos.', resources: 'Oficina de usinagem, Fresadora.' },
  ...
  { id: 'f36', hours: 4, date: '22/04/2026', capacities: 'Montagem de conjuntos; Elementos de máquina.', knowledge: 'TEORIA (TEOR)', strategy: 'Teoria de montagem e tipos de ajustes (Prensado/Folga).', resources: 'Sala de aula.' }
];
    ...
    units: [
      {
        ...
        knowledges: [
          "1. ELEMENTOS DE MÁQUINA: 1.1 Elementos de fixação (Porcas, Parafusos, Arruelas, Contra pino/cupilha, Rebites, Pinos, Cavilhas); 1.2 Elementos de transmissão (Chavetas, Engrenagens, Polias, Correias, Acoplamentos, Roscas de Transmissão, Corrente, Eixos, Sistemas de transmissão, Redutores/Variadores de velocidade); 1.3 Elementos de vedação (Juntas, Retentores, Selos mecânicos, O-Rings); 1.4 Elementos de apoio (Guias lineares, Barramentos, Mancais de deslizamento/rolamentos, Buchas); 1.5 Elementos de instalação (Válvula, Tubulação, Conexão); 1.6 Elementos elásticos (Molas, Anéis elásticos, Pinos elásticos).",
          "2. FERRAMENTAS: 2.1 Manuais; 2.2 Elétricas ou eletrônicas; 2.3 Pneumáticas; 2.4 Portáteis.",
          "3. PROCESSOS DE FABRICAÇÃO: 3.1 Definição; 3.2 Injeção (Metais, Plásticos); 3.3 Manufatura Subtrativa (Torneamento, Furação, Fresamento, Retificação); 3.4 Manufatura aditiva (Soldagem, Impressão 3D); 3.5 Conformação mecânica (Laminação, Trefilação, Extrusão, Forjamento, Repuxo, Dobramento, Corte).",
          "4. MANUTENÇÃO: 4.1 Definição; 4.2 Aplicação; 4.3 Tipos de intervenção (Corretiva, Preventiva, Preditiva, Prescritiva, Emergencial); 4.4 Tipos de ocorrências (Defeito, Falha); 4.5 Documentação técnica.",
          "5. PLANO DE TRABALHO: 5.1 Definição; 5.2 Tipos; 5.3 Características.",
          "6. SEGURANÇA: 6.1 Riscos (Físicos, Mecânicos, Térmicos, Elétricos); 6.2 Equipamentos de proteção (Individual, Coletivo); 6.3 Normas regulamentadoras; 6.4 Sinalização; 6.5 Análise de risco da tarefa - ART; 6.6 Análise preliminar de risco - APR; 6.7 Ficha de Dados de Segurança (FDS).",
          "7. MEIO AMBIENTE: 7.1 Definição; 7.2 Normalização; 7.3 Segregação e descarte de resíduos.",
          "8. PARÂMETROS DE CORTE PARA USINAGEM: 8.1 Cálculos (Rotação por minuto - RPM, Velocidade de corte - Vc, Avanço - f, Profundidade de corte - ap).",
          "9. PARÂMETROS DE FERRAMENTA: 9.1 Material; 9.2 Geometria; 9.3 Número de insertos/dentes (z); 9.4 Raio de ponta (rε).",
          "10. TORNEAMENTO: 10.1 Definição; 10.2 Tipos de tornos (Horizontal, Vertical, De placa ou platô, Revólver, Automático, Copiador, A CNC); 10.3 Ferramentas (Alargador, Bedame, Broca de centro, Broca helicoidal, Cossinete, Escareador, Macho, Recartilha, Rosqueamento externo/interno, Torneamento externo/interno); 10.4 Acessórios (Placas, Contraponta, Arrastador, Mandril); 10.5 Cálculos técnicos (Recartilha, Conicidade com inclinação do carro superior, Rosca triangular); 10.6 Operações (Facear, Tornear cilíndrica, Facear rebaixo, Chanfrar, Furo de centro, Tornear com contraponta, Tornear canal externo, Furar com cabeçote móvel, Escarear, Roscar com cossinete, Tornear cônico, Roscar manual com macho, Recartilhar, Cortar, Tornear entre pontas, Alargar furo, Tornear rosca triangular externa, Tornear cilíndrica interna passante, Facear rebaixo interno, Tornear rosca triangular interna).",
          "11. FRESAGEM: 11.1 Definição; 11.2 Tipos de fresadora (Universal, Ferramenteira, Pantográfica, Copiadora, A CNC, Centros de Usinagem); 11.3 Ferramentas (Cabeçote faceador, Fresa de topo); 11.4 Acessórios (Morsas, Cantoneiras, Calços); 11.5 Operações (Fresar superfície plana, Fresar superfície plana paralela, Fresar superfície perpendicular, Fresar rebaixos, Fresar rasgos, Fresar superfície plana inclinada).",
          "12. FURAÇÃO: 12.1 Definição; 12.2 Tipos de furadeira (De coluna de piso, De coluna de bancada, Radial, Portátil); 12.3 Ferramentas; 12.4 Acessórios (Morsas, Calços, Bucha de redução); 12.5 Parâmetros de corte (Velocidade de Corte - VC, Rotações por minuto - RPM, Avanço - f); 12.6 Operações (Furar na furadeira de coluna de bancada ou de piso, Rebaixar furo, Escarear).",
          "13. ROSQUEAMENTO: 13.1 Definição; 13.2 Ferramentas (Macho, Cossinete); 13.3 Acessórios (Desandador, Porta cossinete); 13.4 Características (Sistema de roscas, Aplicação, Tabelas); 13.5 Máquina (Rosqueadeira); 13.6 Cálculos técnicos (Roscas); 13.7 Operação (Roscar manualmente com macho na bancada).",
          "14. AJUSTAGEM: 14.1 Definição; 14.2 Ferramentas (Limas, Riscadores, Martelos, Punção); 14.3 Acessórios (Morsa de bancada, Mordentes, Cantoneira, Desempeno, Cepo, Calibrador traçador de altura); 14.4 Esmerilhamento (Moto esmeril, Dressadores); 14.5 Operações (Limar superfícies, Traçar retas com calibrador traçador de altura, Puncionar, Serrar manualmente, Limar material fino, Dobrar material fino).",
          "15. CONTROLE DA QUALIDADE: 15.1 Inspeção visual (Rebarbas, Oxidação, Marcas, Riscos); 15.2 Inspeção dimensional (Ficha de autoinspeção, Técnicas de medição).",
          "16. REFRIGERAÇÃO: 16.1 Definição; 16.2 Fluidos de corte (Aplicações, Tipos, Mecanismos, Propriedades); 16.3 Procedimentos."
        ],

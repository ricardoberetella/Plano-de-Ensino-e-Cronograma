...
export const SCHEDULE_VERSION = "2026-V23-PRUSC-160H";
...
export const LIDT_SCHEDULE = [
  ...
  { id: 'l15', date: '18/05/2026', hours: 2, capacities: 'Todas as capacidades da SA.', knowledge: 'Todos os conhecimentos da SA.', strategy: '• Início da divulgação dos croquis detalhados.', resources: 'Papel, instrumentos de desenho.' },
...
export const CRD_SCHEDULE = [
  ...
  { id: 'c17', date: '02/06/2026', hours: 2, capacities: 'Todas as capacidades da SA.', knowledge: 'Apresentação dos resultados de metrologia.', strategy: 'Avaliação prática individual no laboratório.', resources: 'Peças reais e instrumentos.' },
  { id: 'c18', date: '09/06/2026', hours: 2, capacities: 'Todas as capacidades da SA.', knowledge: 'Revisão geral dos relatórios de qualidade.', strategy: 'Entrega de portfólio de medição.', resources: 'Portfólios.' },
  { id: 'c19', date: '16/06/2026', hours: 2, capacities: 'Todas as capacidades da SA.', knowledge: 'Fechamento final.', strategy: 'Entrega de notas e feedback individual.', resources: 'Boletim.' },
  { id: 'c20', date: '23/06/2026', hours: 2, capacities: 'Todas as capacidades da SA.', knowledge: 'Encerramento.', strategy: 'Fechamento de diário e arquivo morto.', resources: 'Sistema.' }
];
...
// Datas mapeadas estritamente de acordo com o calendário letivo do 2º Semestre de 2026
export const PRUSC_SCHEDULE_GEA = [
  ...
  { id: 'pg5', date: '05/08/2026', hours: 4, capacities: 'Realizar operações em torno convencional...', knowledge: '1.3. Cálculos técnicos: 1.3.1. Conicidade com desalinhamento do cabeçote.', strategy: 'Cálculos matemáticos para desalinhamento de cabeçote móvel e prática no torno.', resources: 'Calculadora, torno mecânico, micrômetro.' }, // Balanceamento (Aula de segunda-feira)
  ...
  { id: 'pg11', date: '26/08/2026', hours: 4, capacities: 'Realizar operações em fresadora convencional...', knowledge: '2.3.3. Divisão diferencial.', strategy: 'Demonstração teórica e cálculo da montagem da grade de engrenagens.', resources: 'Engrenagens, cabeçote divisor.' }, // Balanceamento (Aula de segunda-feira)
  ...
  { id: 'pg14', date: '09/09/2026', hours: 4, capacities: 'Realizar operações em fresadora convencional...', knowledge: '2.4.3. Alargar furo manualmente na bancada.', strategy: 'Ajustagem dimensional fina de furos cilíndricos com alargadores manuais.', resources: 'Alargador manual, desandador, bancada.' }, // Segunda-feira 07/09 foi Feriado
  ...
  { id: 'pg23', date: '14/10/2026', hours: 4, capacities: 'Definir os parâmetros e os processos de usinagem...', knowledge: '5.2. Parâmetros (RPM da peça, RPM do rebolo, Avanço).', strategy: 'Cálculo de parâmetros de corte para processos de retificação.', resources: 'Calculadora.' }, // Segunda-feira 12/10 foi Feriado
  ...
  { id: 'pg28', date: '04/11/2026', hours: 4, capacities: 'Realizar o balanceamento do rebolo...', knowledge: '6.3.2. Dressar rebolo.', strategy: 'Operação de dressagem e perfilamento do rebolo com diamante.', resources: 'Dressador de diamante.' }, // Segunda-feira 02/11 foi Feriado
  ...
  { id: 'pg39', date: '14/12/2026', hours: 4, capacities: 'Todas as capacidades da UC.', knowledge: 'Montagem final dos conjuntos mecânicos e análise de ajustes.', strategy: 'Montagem e ajustagem de precisão dos projetos usinados no semestre.', resources: 'Bancadas, ferramentas manuais.' },
  { id: 'pg40', date: '16/12/2026', hours: 4, capacities: 'Todas as capacidades da UC.', knowledge: 'Avaliação Final de Desempenho Atitudinal e Técnico.', strategy: 'Fechamento final do diário de classe, feedback técnico aos alunos e encerramento.', resources: 'Planilhas de notas.' }
];

// --- CRONOGRAMA PRUSC (PROFESSOR BERETELLA - TERÇAS E SEXTAS) - 40 x 4H = 160H ---
// Datas mapeadas estritamente de acordo com o calendário letivo do 2º Semestre de 2026
export const PRUSC_SCHEDULE_BERETELLA = [
  { id: 'pb1', date: '24/07/2026', hours: 4, capacities: 'Realizar operações em torno convencional...', knowledge: 'Introdução aos Processos de Usinagem e Segurança no Trabalho.', strategy: 'Apresentação do plano de ensino, normas de segurança e uso de EPIs na usinagem.', resources: 'Sala de aula, projetor.' }, // Primeira aula de sexta após início em 22/07
  ...
  { id: 'pb14', date: '08/09/2026', hours: 4, capacities: 'Realizar operações em fresadora convencional...', knowledge: '2.4.3. Alargar furo manualmente na bancada.', strategy: 'Ajustagem dimensional fina de furos cilíndricos com alargadores manuais.', resources: 'Alargador manual, desandador, bancada.' }, // Balanceamento do dia letivo (Aula de terça-feira I)
  ...
  { id: 'pb33', date: '13/11/2026', hours: 4, capacities: 'Realizar operações em retificadoras planas...', knowledge: '8. Retificadora plana: 8.1. Characteristics; 8.2. Componentes.', strategy: 'Identificação dos controles da retificadora plana tangencial.', resources: 'Retificadora plana.' },
  ...
  { id: 'pb39', date: '04/12/2026', hours: 4, capacities: 'Todas as capacidades da UC.', knowledge: 'Montagem final dos conjuntos mecânicos e análise de ajustes.', strategy: 'Montagem e ajustagem de precisão dos projetos usinados no semestre.', resources: 'Bancadas, ferramentas manuais.' },
  { id: 'pb40', date: '08/12/2026', hours: 4, capacities: 'Todas as capacidades da UC.', knowledge: 'Avaliação Final de Desempenho Atitudinal e Técnico.', strategy: 'Fechamento final do diário de classe, feedback técnico aos alunos e encerramento.', resources: 'Planilhas de notas.' }
];

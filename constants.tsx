...
// Atualizado para forçar o Firebase a atualizar com os dados mestres completos de recuperação
export const SCHEDULE_VERSION = "2026-V12-RESTORE-FULL";

// --- CRONOGRAMA LIDT (Completo) ---
...
export const FUSI_SCHEDULE_GEA = [
  ...
  { id: 'g08', hours: 4, date: '10/02/2026', capacities: 'Inspeção dimensional; Refrigeração; Zelar pelo equipamento.', knowledge: 'PRÁTICA (PRAT)', strategy: 'Tarefa: Eixo 4 Corpos. Controle final e organization.', resources: 'Oficina de usinagem, Micrômetro.' },
  ...
  { id: 'g52', hours: 4, date: '27/05/2026', capacities: 'Preparação para Avaliação Final (Teoria).', knowledge: 'TEORIA (TEOR)', strategy: 'Revisão integral dos conteúdos estruturados.', resources: 'Sala de aula.' },
...
// --- CRONOGRAMA FUSI (PADRÃO BERETELLA - CONTINUAÇÃO RECONSTRUÍDA) ---
export const FUSI_SCHEDULE = [
  ...FUSI_SCHEDULE_GEA.map((item, idx) => ({
    ...item,
    id: `f${String(idx + 1).padStart(2, '0')}`
  }))
];

// --- OBJETO MESTRE DE MODELO DE PLANO (SAMPLE_PLANS) ---
export const SAMPLE_PLANS: TeachingPlan[] = [
  {
    id: 'plano-mecanico-usinagem-2026',
    profileId: 'beretella',
    courseName: 'Mecânico de Usinagem Convencional',
    totalHours: 800,
    modality: 'Aprendizagem Industrial',
    objective: 'Desenvolver capacidades para operar máquinas-ferramenta convencionais realizando torneamento, fresagem, furação e ajustagem mecânica seguindo normas técnicas, ambientais e de segurança.',
    units: [
      {
        id: 'crd-2026',
        ...
        calendar: {
          ...
          endDate: '2026-06-23',
          daysOfWeek: [2], // Terças-feiras
          excludedDates: ['2026-02-17', '2026-04-21'] // Pontes/Feriados
        }
      },
      {
        id: 'lidt-2026',
        ...
        calendar: {
          ...
          endDate: '2026-06-22',
          daysOfWeek: [1], // Segundas-feiras
          excludedDates: ['2026-02-16', '2026-03-23']
        }
      },
      {
        id: 'fusi-2026',
        ...
        calendar: {
          startDate: '2026-01-26',
          endDate: '2026-06-22',
          daysOfWeek: [1, 2, 3, 4], // Segundas a Quintas
          excludedDates: []
        }
      }
    ]
  ...
  {
    id: 'plano-mecanico-usinagem-2026-gea',
    profileId: 'gea',
    ...
    units: [
      {
        ...
        hours: 60,
        schedule: CRD_SCHEDULE,
        calendar: { startDate: '2026-01-27', endDate: '2026-06-23', daysOfWeek: [2], excludedDates: [] }
      },
      {
        id: 'lidt-gea-2026',
        name: 'Leitura e Interpretação de Desenho Técnico (LIDT)',
        hours: 60,
        schedule: LIDT_SCHEDULE,
        calendar: { startDate: '2026-01-26', endDate: '2026-06-22', daysOfWeek: [1], excludedDates: [] }
      },
      {
        id: 'fusi-gea-2026',
        name: 'Fundamentos da Usinagem (FUSI)',
        ...
        calendar: { startDate: '2026-01-26', endDate: '2026-06-22', daysOfWeek: [1, 2, 3], excludedDates: [] }
      }
    ]
  }
];

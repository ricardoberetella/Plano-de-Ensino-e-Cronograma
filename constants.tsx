...
export const SCHEDULE_VERSION = "2026-V16-BERETELLA-FINAL-SYNC";
...
// --- CRONOGRAMA FUSI (PADRÃO BERETELLA - 60 AULAS / 240H) ---
// Conteúdo idêntico ao Ricardo Gea, datas seguindo Seg/Qua/Qui de Beretella terminando em 22/06
export const FUSI_SCHEDULE = [
  ...
  { id: 'f10', hours: 4, date: '18/02/2026', capacities: 'Fresagem (Rebaixos); Superfícies perpendiculares.', knowledge: 'Fresagem Convencional', strategy: 'Tarefa: Bloco Fresado. Usinagem de rebaixos e controle.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f11', hours: 4, date: '19/02/2026', capacities: 'Aplicar refrigeração; Fresagem (Operações avançadas).', knowledge: 'Fresagem Convencional', strategy: 'Tarefa: Bloco Fresado. Prática de acabamento em fresa.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f12', hours: 4, date: '23/02/2026', capacities: 'Rosqueamento (Definição, Ferramentas); Roscar com Cossinete.', knowledge: 'Tecnologia de Roscas', strategy: 'Teoria de cálculos para furação de roscas e tipos de roscas.', resources: 'Sala de aula.' },
  { id: 'f13', hours: 4, date: '25/02/2026', capacities: 'Tornear cilíndrica; Roscar com cossinete no torno.', knowledge: 'Operações de Torno', strategy: 'Tarefa: Eixo Roscado. Tornear diâmetro e executar roscagem.', resources: 'Oficina de usinagem, Torno, Cossinete.' },
  { id: 'f14', hours: 4, date: '26/02/2026', capacities: 'Furação; Roscar manualmente com macho na bancada.', knowledge: 'Operações de Furação', strategy: 'Tarefa: Manípulo. Furação em furadeira e rosca manual.', resources: 'Oficina de usinagem, Bancada, Machos.' },
  { id: 'f15', hours: 4, date: '02/03/2026', capacities: 'Elementos de máquina; Visão sistêmica; Planejar ações.', knowledge: 'Elementos de Máquina', strategy: 'Desafio 1: Planejamento do Calculador de Usinagem.', resources: 'Sala de aula.' },
  { id: 'f16', hours: 4, date: '04/03/2026', capacities: 'Parâmetros de usinagem; Tornear superfície cilíndrica; Facear.', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Início da base cilíndrica (Torno).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f17', hours: 4, date: '05/03/2026', capacities: 'Fresagem de superfícies planas e esquadrejamento.', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Preparação do bloco principal (Fresadora).', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f18', hours: 4, date: '09/03/2026', capacities: 'Revisão de tolerâncias; Ajustagem mecânica (Definição).', knowledge: 'Ajustagem Mecânica', strategy: 'Estudo de ajustes e folgas para montagem do Desafio 1.', resources: 'Sala de aula.' },
  { id: 'f19', hours: 4, date: '11/03/2026', capacities: 'Tornear cilíndrica; Furo de centro; Chanfrar.', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Usinagem de eixos internos e pinos (Torno).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f20', hours: 4, date: '12/03/2026', capacities: 'Fresagem de rebaixos e canais com fresa de topo.', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Detalhes do corpo principal (Fresadora).', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f21', hours: 4, date: '16/03/2026', capacities: 'Processos de furação e rosqueamento (Normas).', knowledge: 'Furação e Rosqueamento', strategy: 'Estudo técnico sobre furação coordenada e tabelas de roscas.', resources: 'Sala de aula.' },
  { id: 'f22', hours: 4, date: '18/03/2026', capacities: 'Furação; Rosqueamento manual e no torno.', knowledge: 'Operações de Furação', strategy: 'Desafio 1: Furação e rosqueamento de componentes.', resources: 'Oficina de usinagem.' },
  { id: 'f23', hours: 4, date: '19/03/2026', capacities: 'Furação em fresadora; Controle de qualidade.', knowledge: 'Fresagem e Controle', strategy: 'Desafio 1: Furação coordenada do corpo do calculador.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f24', hours: 4, date: '23/03/2026', knowledge: 'Manutenção e Segurança', capacities: 'Manutenção preventiva; Segurança do trabalho; Meio Ambiente.', strategy: 'Teoria sobre descarte de resíduos e lubrificação de máquinas.', resources: 'Sala de aula.' },
  { id: 'f25', hours: 4, date: '25/03/2026', capacities: 'Tornear cilíndrica; Inspeção com micrômetro.', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Acabamento de diâmetros críticos (Torno).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f26', hours: 4, date: '26/03/2026', capacities: 'Fresagem; Superfícies paralelas e perpendiculares.', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Acabamento final das faces do bloco.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f27', hours: 4, date: '30/03/2026', capacities: 'Relatórios técnicos; Controle de processos; Organização.', knowledge: 'Qualidade Industrial', strategy: 'Documentação de controle de qualidade (Teoria).', resources: 'Sala de aula.' },
  { id: 'f28', hours: 4, date: '01/04/2026', capacities: 'Ajustagem manual; Rebarbação; Limagem técnica.', knowledge: 'Ajustagem Mecânica', strategy: 'Desafio 1: Ajustagem manual das peças para encaixe.', resources: 'Bancada, Limas.' },
  { id: 'f29', hours: 4, date: '02/04/2026', capacities: 'Inspeção visual; Verificação funcional de conjuntos.', knowledge: 'Montagem e Teste', strategy: 'Desafio 1: Pró-montagem e detecção de interferências.', resources: 'Bancada.' },
  { id: 'f30', hours: 4, date: '06/04/2026', capacities: 'Revisão Geral: Torneamento Convencional.', knowledge: 'Torneamento Convencional', strategy: 'Debate técnico: Soluções para problemas em torneamento.', resources: 'Sala de aula.' },
  { id: 'f31', hours: 4, date: '08/04/2026', capacities: 'Tornear; Chanfrar; Roscar com cossinete.', knowledge: 'Operações de Torno', strategy: 'Tarefa Reforço: Repetição do Eixo Roscado.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f32', hours: 4, date: '09/04/2026', capacities: 'Fresar; Furação de precisão; Qualidade.', knowledge: 'Fresagem e Qualidade', strategy: 'Tarefa Reforço: Ajuste de blocos paralelos.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f33', hours: 4, date: '13/04/2026', capacities: 'Revisão Geral: Fresamento e Ajustagem.', knowledge: 'Fresamento e Ajustagem', strategy: 'Debate técnico: Otimização de tempo no setup de máquinas.', resources: 'Sala de aula.' },
  { id: 'f34', hours: 4, date: '15/04/2026', capacities: 'Prática Supervisionada Avançada (Torneamento).', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Refino dimensional das peças cilíndricas.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f35', hours: 4, date: '16/04/2026', capacities: 'Prática Supervisionada Avançada (Fresamento).', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Refino dimensional do bloco fresado.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f36', hours: 4, date: '20/04/2026', capacities: 'Gestão de Ferramental e Almoxarifado técnico.', knowledge: 'Gestão de Oficina', strategy: 'Organização e controle de vida útil das ferramentas.', resources: 'Sala de aula.' },
  { id: 'f37', hours: 4, date: '22/04/2026', capacities: 'Montagem de conjuntos; Elementos de máquina.', knowledge: 'Montagem Industrial', strategy: 'Teoria de montagem e tipos de ajustes (Prensado/Folga).', resources: 'Sala de aula.' },
  { id: 'f38', hours: 4, date: '23/04/2026', capacities: 'Controle da qualidade das peças; Inspeção dimensional.', knowledge: 'Controle de Qualidade', strategy: 'Avaliação dimensional total (Micrômetro).', resources: 'Sala de aula, Micrômetro.' },
  { id: 'f39', hours: 4, date: '27/04/2026', capacities: 'Tornear; Facear; Furo de centro (Novas peças).', knowledge: 'Operações de Torno', strategy: 'Tarefa Extra: Início de peça auxiliar (Base castanha).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f40', hours: 4, date: '29/04/2026', capacities: 'Manutenção; Segurança do trabalho (NR-12).', knowledge: 'Segurança Industrial', strategy: 'Teoria sobre proteções e dispositivos de emergência.', resources: 'Sala de aula.' },
  { id: 'f41', hours: 4, date: '30/04/2026', capacities: 'Fresar; Rebaixos; Furação (Novas peças).', knowledge: 'Fresagem Convencional', strategy: 'Tarefa Extra: Usinagem de base auxiliar (Fresadora).', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f42', hours: 4, date: '04/05/2026', capacities: 'Tornear cilíndrica; Roscar com cossinete.', knowledge: 'Operações de Torno', strategy: 'Prática de roscagem em diferentes diâmetros.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f43', hours: 4, date: '06/05/2026', capacities: 'Parâmetros avançados (Materiais especiais).', knowledge: 'Tecnologia de Materiais', strategy: 'Estudo de tabelas para Aço Inox e Bronze (Teoria).', resources: 'Sala de aula.' },
  { id: 'f44', hours: 4, date: '07/05/2026', capacities: 'Fresagem de superfícies perpendiculares.', knowledge: 'Fresagem Convencional', strategy: 'Prática de esquadrejamento de precisão.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f45', hours: 4, date: '11/05/2026', capacities: 'Cortar no torno (Bedame); Abrir canais.', knowledge: 'Operações de Torno', strategy: 'Operações de sangramento e canais técnicos.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f46', hours: 4, date: '13/05/2026', capacities: 'Relatórios de Não Conformidade; Ações corretivas.', knowledge: 'Gestão da Qualidade', strategy: 'Como documentar erros e recuperar peças (Teoria).', resources: 'Sala de aula.' },
  { id: 'f47', hours: 4, date: '14/05/2026', capacities: 'Rosquear manual com macho na bancada.', knowledge: 'Ajustagem Mecânica', strategy: 'Prática intensiva de roscagem em furos cegos.', resources: 'Oficina de usinagem, Bancada.' },
  { id: 'f48', hours: 4, date: '18/05/2026', capacities: 'Ajustagem mecânica: Limagem plana.', knowledge: 'Ajustagem Mecânica', strategy: 'Prática de ajustagem ao banco (precisão manual).', resources: 'Bancada, Limas.' },
  { id: 'f49', hours: 4, date: '20/05/2026', capacities: 'Elementos de fixação e transmissão (Teoria).', knowledge: 'Elementos de Máquina', strategy: 'Estudo sobre chavetas e eixos estriados.', resources: 'Sala de aula.' },
  { id: 'f50', hours: 4, date: '21/05/2026', capacities: 'Controle dimensional de conjuntos montados.', knowledge: 'Montagem e Qualidade', strategy: 'Testes funcionais e ajustes de interferência.', resources: 'Oficina de usinagem.' },
  { id: 'f51', hours: 4, date: '25/05/2026', capacities: 'Torneamento: Prática de acabamento superficial.', knowledge: 'Operações de Torno', strategy: 'Foco em rugosidade e brilho no torno.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'f52', hours: 4, date: '27/05/2026', capacities: 'Preparação para Avaliação Final (Teoria).', knowledge: 'Revisão Técnica', strategy: 'Revisão integral dos conteúdos dos Blocos 1, 2 e 3.', resources: 'Sala de aula.' },
  { id: 'f53', hours: 4, date: '28/05/2026', capacities: 'Fresagem: Prática de acabamento (Cabeçote).', knowledge: 'Fresagem Convencional', strategy: 'Foco em planeza e acabamento superficial.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'f54', hours: 4, date: '01/06/2026', capacities: 'Conclusão de peças pendentes do semestre.', knowledge: 'Oficina de Finalização', strategy: 'Prática de Oficina Final (Arremates).', resources: 'Oficina de usinagem.' },
  { id: 'f55', hours: 4, date: '03/06/2026', capacities: 'Ética Profissional e Postura no Trabalho.', knowledge: 'Desenvolvimento Profissional', strategy: 'Atitudes, responsabilidade e zelo com patrimônio.', resources: 'Sala de aula.' },
  { id: 'f56', hours: 4, date: '08/06/2026', capacities: 'Limpeza Técnica e Conservação.', knowledge: 'Manutenção e Zelo', strategy: 'Limpeza profunda e lubrificação das máquinas.', resources: 'Oficina de usinagem.' },
  { id: 'f57', hours: 4, date: '15/06/2026', capacities: 'Organização do ambiente (5S).', knowledge: 'Organização Industrial', strategy: 'Organização de armários e entrega de ferramentas.', resources: 'Oficina de usinagem.' },
  { id: 'f58', hours: 4, date: '17/06/2026', capacities: 'Revisão Geral de Processos e Documentação.', knowledge: 'Gestão de Processos', strategy: 'Conferência de diários e fichas técnicas.', resources: 'Sala de aula.' },
  { id: 'f59', hours: 4, date: '18/06/2026', capacities: 'Feedback Final e Divulgação de Notas.', knowledge: 'Encerramento Letivo', strategy: 'Encerramento letivo em sala de aula.', resources: 'Sala de aula.' },
  { id: 'f60', hours: 4, date: '22/06/2026', capacities: 'Entrega Final das Peças e Avaliação de Resultados.', knowledge: 'Avaliação de Resultados', strategy: 'Finalização de todas as atividades de oficina.', resources: 'Oficina de usinagem.' }
];
...
export const FUSI_SCHEDULE_GEA = [
  ...
  { id: 'g14', hours: 4, date: '24/02/2026', capacities: 'Furação; Roscar manualmente com macho na bancada.', knowledge: 'Operações de Furação', strategy: 'Tarefa: Manípulo. Furação em furadeira e rosca manual.', resources: 'Oficina de usinagem, Bancada, Machos.' },
  ...
  { id: 'g18', hours: 4, date: '04/03/2026', capacities: 'Revisão de tolerâncias; Ajustagem mecânica (Definição).', knowledge: 'Ajustagem Mecânica', strategy: 'Estudo de ajustes e folgas para montagem do Desafio 1.', resources: 'Sala de aula.' },
  { id: 'g19', hours: 4, date: '09/03/2026', capacities: 'Tornear cilíndrica; Furo de centro; Chanfrar.', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Usinagem de eixos internos e pinos (Torno).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g20', hours: 4, date: '10/03/2026', capacities: 'Fresagem de rebaixos e canais com fresa de topo.', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Detalhes do corpo principal (Fresadora).', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g21', hours: 4, date: '11/03/2026', capacities: 'Processos de furação e rosqueamento (Normas).', knowledge: 'Furação e Rosqueamento', strategy: 'Estudo técnico sobre furação coordenada e tabelas de roscas.', resources: 'Sala de aula.' },
  { id: 'g22', hours: 4, date: '16/03/2026', capacities: 'Furação; Rosqueamento manual e no torno.', knowledge: 'Operações de Furação', strategy: 'Desafio 1: Furação e rosqueamento de componentes.', resources: 'Oficina de usinagem.' },
  { id: 'g23', hours: 4, date: '17/03/2026', capacities: 'Furação em fresadora; Controle de qualidade.', knowledge: 'Fresagem e Controle', strategy: 'Desafio 1: Furação coordenada do corpo do calculador.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g24', hours: 4, date: '18/03/2026', knowledge: 'Manutenção e Segurança', capacities: 'Manutenção preventiva; Segurança do trabalho; Meio Ambiente.', strategy: 'Teoria sobre descarte de resíduos e lubrificação de máquinas.', resources: 'Sala de aula.' },
  { id: 'g25', hours: 4, date: '23/03/2026', capacities: 'Tornear cilíndrica; Inspeção com micrômetro.', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Acabamento de diâmetros críticos (Torno).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g26', hours: 4, date: '24/03/2026', capacities: 'Fresagem; Superfícies paralelas e perpendiculares.', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Acabamento final das faces do bloco.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g27', hours: 4, date: '25/03/2026', capacities: 'Relatórios técnicos; Controle de processos; Organização.', knowledge: 'Qualidade Industrial', strategy: 'Documentação de controle de qualidade (Teoria).', resources: 'Sala de aula.' },
  { id: 'g28', hours: 4, date: '30/03/2026', capacities: 'Ajustagem manual; Rebarbação; Limagem técnica.', knowledge: 'Ajustagem Mecânica', strategy: 'Desafio 1: Ajustagem manual das peças para encaixe.', resources: 'Bancada, Limas.' },
  { id: 'g29', hours: 4, date: '31/03/2026', capacities: 'Inspeção visual; Verificação funcional de conjuntos.', knowledge: 'Montagem e Teste', strategy: 'Desafio 1: Pró-montagem e detecção de interferências.', resources: 'Bancada.' },
  { id: 'g30', hours: 4, date: '01/04/2026', capacities: 'Revisão Geral: Torneamento Convencional.', knowledge: 'Torneamento Convencional', strategy: 'Debate técnico: Soluções para problemas em torneamento.', resources: 'Sala de aula.' },
  { id: 'g31', hours: 4, date: '06/04/2026', capacities: 'Tornear; Chanfrar; Roscar com cossinete.', knowledge: 'Operações de Torno', strategy: 'Tarefa Reforço: Repetição do Eixo Roscado.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g32', hours: 4, date: '07/04/2026', capacities: 'Fresar; Furação de precisão; Qualidade.', knowledge: 'Fresagem e Qualidade', strategy: 'Tarefa Reforço: Ajuste de blocos paralelos.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g33', hours: 4, date: '08/04/2026', capacities: 'Revisão Geral: Fresamento e Ajustagem.', knowledge: 'Fresamento e Ajustagem', strategy: 'Debate técnico: Otimização de tempo no setup de máquinas.', resources: 'Sala de aula.' },
  { id: 'g34', hours: 4, date: '13/04/2026', capacities: 'Prática Supervisionada Avançada (Torneamento).', knowledge: 'Operações de Torno', strategy: 'Desafio 1: Refino dimensional das peças cilíndricas.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g35', hours: 4, date: '14/04/2026', capacities: 'Prática Supervisionada Avançada (Fresamento).', knowledge: 'Fresagem Convencional', strategy: 'Desafio 1: Refino dimensional do bloco fresado.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g36', hours: 4, date: '15/04/2026', capacities: 'Gestão de Ferramental e Almoxarifado técnico.', knowledge: 'Gestão de Oficina', strategy: 'Organização e controle de vida útil das ferramentas.', resources: 'Sala de aula.' },
  { id: 'g37', hours: 4, date: '22/04/2026', capacities: 'Montagem de conjuntos; Elementos de máquina.', knowledge: 'Montagem Industrial', strategy: 'Teoria de montagem e tipos de ajustes (Prensado/Folga).', resources: 'Sala de aula.' },
  { id: 'g38', hours: 4, date: '27/04/2026', capacities: 'Controle da qualidade das peças; Inspeção dimensional.', knowledge: 'Controle de Qualidade', strategy: 'Avaliação dimensional total (Micrômetro).', resources: 'Sala de aula, Micrômetro.' },
  { id: 'g39', hours: 4, date: '28/04/2026', capacities: 'Tornear; Facear; Furo de centro (Novas peças).', knowledge: 'Operações de Torno', strategy: 'Tarefa Extra: Início de peça auxiliar (Base castanha).', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g40', hours: 4, date: '29/04/2026', capacities: 'Manutenção; Segurança do trabalho (NR-12).', knowledge: 'Segurança Industrial', strategy: 'Teoria sobre proteções e dispositivos de emergência.', resources: 'Sala de aula.' },
  { id: 'g41', hours: 4, date: '04/05/2026', capacities: 'Fresar; Rebaixos; Furação (Novas peças).', knowledge: 'Fresagem Convencional', strategy: 'Tarefa Extra: Usinagem de base auxiliar (Fresadora).', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g42', hours: 4, date: '05/05/2026', capacities: 'Tornear cilíndrica; Roscar com cossinete.', knowledge: 'Operações de Torno', strategy: 'Prática de roscagem em diferentes diâmetros.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g43', hours: 4, date: '06/05/2026', capacities: 'Parâmetros avançados (Materiais especiais).', knowledge: 'Tecnologia de Materiais', strategy: 'Estudo de tabelas para Aço Inox e Bronze (Teoria).', resources: 'Sala de aula.' },
  { id: 'g44', hours: 4, date: '11/05/2026', capacities: 'Fresagem de superfícies perpendiculares.', knowledge: 'Fresagem Convencional', strategy: 'Prática de esquadrejamento de precisão.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g45', hours: 4, date: '12/05/2026', capacities: 'Cortar no torno (Bedame); Abrir canais.', knowledge: 'Operações de Torno', strategy: 'Operações de sangramento e canais técnicos.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g46', hours: 4, date: '13/05/2026', capacities: 'Relatórios de Não Conformidade; Ações corretivas.', knowledge: 'Gestão da Qualidade', strategy: 'Como documentar erros e recuperar peças (Teoria).', resources: 'Sala de aula.' },
  { id: 'g47', hours: 4, date: '18/05/2026', capacities: 'Rosquear manual com macho na bancada.', knowledge: 'Ajustagem Mecânica', strategy: 'Prática intensiva de roscagem em furos cegos.', resources: 'Oficina de usinagem, Bancada.' },
  { id: 'g48', hours: 4, date: '19/05/2026', capacities: 'Ajustagem mecânica: Limagem plana.', knowledge: 'Ajustagem Mecânica', strategy: 'Prática de ajustagem ao banco (precisão manual).', resources: 'Bancada, Limas.' },
  { id: 'g49', hours: 4, date: '20/05/2026', capacities: 'Elementos de fixação e transmissão (Teoria).', knowledge: 'Elementos de Máquina', strategy: 'Estudo sobre chavetas e eixos estriados.', resources: 'Sala de aula.' },
  { id: 'g50', hours: 4, date: '25/05/2026', capacities: 'Controle dimensional de conjuntos montados.', knowledge: 'Montagem e Qualidade', strategy: 'Testes funcionais e ajustes de interferência.', resources: 'Oficina de usinagem.' },
  { id: 'g51', hours: 4, date: '26/05/2026', capacities: 'Torneamento: Prática de acabamento superficial.', knowledge: 'Operações de Torno', strategy: 'Foco em rugosidade e brilho no torno.', resources: 'Oficina de usinagem, Torno.' },
  { id: 'g52', hours: 4, date: '27/05/2026', capacities: 'Preparação para Avaliação Final (Teoria).', knowledge: 'Revisão Técnica', strategy: 'Revisão integral dos conteúdos dos Blocos 1, 2 e 3.', resources: 'Sala de aula.' },
  { id: 'g53', hours: 4, date: '01/06/2026', capacities: 'Fresagem: Prática de acabamento (Cabeçote).', knowledge: 'Fresagem Convencional', strategy: 'Foco em planeza e acabamento superficial.', resources: 'Oficina de usinagem, Fresadora.' },
  { id: 'g54', hours: 4, date: '02/06/2026', capacities: 'Conclusão de peças pendentes do semestre.', knowledge: 'Oficina de Finalização', strategy: 'Prática de Oficina Final (Arremates).', resources: 'Oficina de usinagem.' },
  { id: 'g55', hours: 4, date: '03/06/2026', capacities: 'Ética Profissional e Postura no Trabalho.', knowledge: 'Desenvolvimento Profissional', strategy: 'Atitudes, responsabilidade e zelo com patrimônio.', resources: 'Sala de aula.' },
  { id: 'g56', hours: 4, date: '08/06/2026', capacities: 'Limpeza Técnica e Conservação.', knowledge: 'Manutenção e Zelo', strategy: 'Limpeza profunda e lubrificação das máquinas.', resources: 'Oficina de usinagem.' },
  { id: 'g57', hours: 4, date: '09/06/2026', capacities: 'Organização do ambiente (5S).', knowledge: 'Organização Industrial', strategy: 'Organização de armários e entrega de ferramentas.', resources: 'Oficina de usinagem.' },
  { id: 'g58', hours: 4, date: '10/06/2026', capacities: 'Revisão Geral de Processos e Documentação.', knowledge: 'Gestão de Processos', strategy: 'Conferência de diários e fichas técnicas.', resources: 'Sala de aula.' },
  { id: 'g59', hours: 4, date: '11/06/2026', capacities: 'Feedback Final e Divulgação de Notas.', knowledge: 'Encerramento Letivo', strategy: 'Encerramento letivo em sala de aula.', resources: 'Sala de aula.' },
  { id: 'g60', hours: 4, date: '22/06/2026', capacities: 'Entrega Final das Peças e Avaliação de Resultados.', knowledge: 'Avaliação de Resultados', strategy: 'Finalização de todas as atividades de oficina.', resources: 'Oficina de usinagem.' }
];

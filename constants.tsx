...
// --- CRONOGRAMA FUSI (EFETIVO - 60 AULAS DE 4H = 240H TOTAL) ---
// Baseado fielmente na planilha de 10 páginas fornecida pelo usuário.
export const FUSI_SCHEDULE = [
  ...
  { id: 'f38', hours: 4, date: '25/04/2026', capacities: 'Compensação: Revisão de Metrologia e Desenho Técnico.', knowledge: 'TEORIA (TEOR)', strategy: 'Aula teórica em dia letivo compensado.', resources: 'Sala de aula.' },

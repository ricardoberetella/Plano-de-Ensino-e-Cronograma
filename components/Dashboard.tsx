...
const Dashboard: React.FC<DashboardProps> = ({
  ...
  const formatSyncDate = (plan: TeachingPlan) => {
    const raw = (plan as any).updatedAt || plan.createdAt;
    if (!raw) return '—';
              ...
              <tr key={plan.id} className="hover:bg-slate-50 transition-colors group">
                ...
                <td className="px-6 py-4">
                  <div className="flex gap-2 justify-center">
                    ...
                    <button
                      onClick={async () => {
                        const ok = window.confirm("Deseja excluir este plano do Firebase?");
                        if (!ok) return;
                        ...
                        try {
                          ...
                          alert("Não foi possível excluir o plano. Verifique a conexão e tente novamente.");
                        }
                      }}
                      title="Excluir Plano"
              ...
              <tr>
                <td colSpan={4} className="px-6 py-20 text-center">
                  <p className="text-slate-400 font-black uppercase text-[10px] tracking-widest italic">
                    Aguardando planos do Firebase Cloud...
                  </p>
                </td>
              </tr>
            )}

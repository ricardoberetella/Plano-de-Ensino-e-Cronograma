...
const Layout: React.FC<LayoutProps> = ({ 
  ...
  const menuItems: { id: ViewType; label: string; icon: React.RefObject<any> | React.ReactNode; external?: string }[] = [
    ...
    { id: 'plano-demonstracao', label: 'Plano de Demonstração', external: 'https://plano-de-demonstra-es.vercel.app/', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg> },
